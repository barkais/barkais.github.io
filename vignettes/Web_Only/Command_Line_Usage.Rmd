...
vignette: >
  %\VignetteIndexEntry{Command_Line_Usage}
...
##### Arguments:
  ...
  **only_sub:**
  ...
  <center><img src="../../man/figures/sterimol_CLU.png" width="600" height="220"></center>
...
Users can avoid this step by setting `only_sub = F`
  ...
  **drop:**
  ...
  <center><img src="../../man/figures/sterimol_drop.png" width="500" height="250"></center>
...
dip.gaussian.multi(coor_atoms = '1 2 3',
                ...
                subunits_inputs_vector = '3 4 5 6 7 8')
...
dip.gaussian.multi(coor_atoms = '1 2 3',
                center_of_mass = F, 
                center_of_mass_substructure = T,
                subunits_inputs_vector = c('3 4 5 6 7 8', '1 2 3'))
...
<center><img src="../../man/figures/npa_dm.png" width="600" height="476"></center>
